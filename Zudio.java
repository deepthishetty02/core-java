...
String[] beautyItems={"Soap","Shampoo","FaceWash","Cream","Lotion","Perfume","Powder","Lipstick","Kajal","Serum","Sunscreen","FacePack","Deo","Gel","Oil"};
String[] footwears={"Shoes","Sandals","Slippers","Heels","Boots","Loafers","Sneakers","Flipflops","SportsShoes"
,"FormalShoes","CasualShoes","Ethnic","Canvas","PartyWear","Running"};
String[] homeItems={"Chair","Table","Bed","Sofa","Mat","Curtain","Pillow","Blanket","Cover","Stand","Shelf","Lamp","Clock","Mirror","Bucket"};
...
for(String x:beautyItems){
System.out.println(x);
}

for(int i=0;i<footwears.length;i++){
System.out.println(footwears[i]);
}

for(String y:homeItems){
